...
FALCON9_UPPER_STAGE_PROPELLANT_KG = 92_670.0
FALCON9_UPPER_STAGE_DRY_PAYLOAD_MASS_KG = (
  FALCON9_ATTACHED_UPPER_STACK_MASS_KG - FALCON9_UPPER_STAGE_PROPELLANT_KG
)
